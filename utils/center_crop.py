...
def center_crop(file_path, seg_path, sub_id, target_path):
    ...
    raw_path = os.path.join(target_path, 'T2',sub_id+'_T2w.nii.gz')
    seg_save_path = os.path.join(target_path, 'Seg',sub_id+'_dseg.nii.gz')
